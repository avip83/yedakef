// פאזל תמונות פשוט עם Ishan's Jigsaw Embed - 9 חלקים מתכוונן
            ...
            <div style="background: white; border-radius: 20px; padding: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); margin-bottom: 20px; max-width: 90vw;">
                ...
                <div id="puzzleContainer" style="text-align: center;">
                    <iframe id="puzzleFrame" 
                            src="https://jigsaw.ishan.page?img=${encodeURIComponent(window.location.origin + '/' + randomImage)}&pieces=9&bg=ffffff" 
                            width="600" 
                            height="450" 
...
function createNewPuzzle() {
    ...
    // עדכון הפאזל
    puzzleFrame.src = `https://jigsaw.ishan.page?img=${encodeURIComponent(window.location.origin + '/' + randomImage)}&pieces=${pieces}&bg=ffffff`;

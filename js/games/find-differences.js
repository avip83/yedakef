window['find-differences'] = {
  ...
  renderGame() {
    ...
    const diffs = [
      // 1 (מקושרות)
      [ {left: 0.645, top: 0.189, w: 0.076, h: 0.114}, {left: 0.081, top: 0.182, w: 0.076, h: 0.114} ],
      // 2 (מקושרות)
      [ {left: 0.731, top: 0.904, w: 0.207, h: 0.100}, {left: 0.167, top: 0.896, w: 0.207, h: 0.100} ],
      // 3 (מקושרות)
      [ {left: 0.724, top: 0.250, w: 0.055, h: 0.089}, {left: 0.148, top: 0.257, w: 0.055, h: 0.089} ],
      // 4 (מקושרות)
      [ {left: 0.871, top: 0.407, w: 0.076, h: 0.186}, {left: 0.286, top: 0.432, w: 0.076, h: 0.186} ]
    ];
    // שכבת אינטראקציה
